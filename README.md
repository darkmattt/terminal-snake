...
## About the game
This in-terminal snake game has support for custom map sizes (from 5×5 to however your screen is big), custom number of apples, and optional computer opponents (0-4).
...
**Not every commit is going to be stable!**
